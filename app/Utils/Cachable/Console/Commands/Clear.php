...
namespace App\Utils\Cachable\Console\Commands;
...
class Clear extends Command
{
    ...
    protected function flushEntireCache() : int
    {
        ...
        $this->info("Entire model cache has been flushed.");
    ...
    protected function flushModelCache(string $option) : int
    {
        ...
        $usesCachableTrait = $this->getAllTraitsUsedByClass($option)
            ->contains("App\Utils\Cachable\Traits\Cachable");
        ...
        $model->flushCache();
        $this->info("Cache for model '{$option}' has been flushed.");

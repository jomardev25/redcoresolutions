<template>
    <div class="w-100">
        <card>
            <template #header>
                <h6 class="card__title">Edit User</h6>
            </template>
            ...
            <template #footer>
                <div class="form-action">
                    ...
                    <button-loader ref="btnSubmit" class="btn--primary" @click="handleUpdateUser">Update User</button-loader>
                </div>
            </template>
        </card>
    </div>
...
import { fetchEditUser, updateUser } from "@/api/user";
export default {
    name: "Create",
    data(){
        return {
    ...
    methods: {
        async fetchData(){
            try {
                const response = await fetchEditUser(this.$route.params.id);
        ...
        async handleUpdateUser(){
            ...
            this.loading = true;
            try {
                const response = await updateUser(this.$route.params.id, this.form);

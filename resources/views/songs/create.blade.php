    ...
    <div class="row mb-3 justify-content-center">
        <div class="col-sm-12">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    <form id="form-create-song" method="POST" action="{{ route('songs.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="lyrics" name="lyrics" class="form-control" cols="8" row="4"></textarea>
                        </div>
...
@section('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\SongRequest', '#form-create-song') !!}
@endsection

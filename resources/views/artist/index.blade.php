            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table-artists" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                ...
                                @forelse ($artists as $artist)
                                    <tr>
                                        <td
                                            ...
                                            <a
                                                href="{{ route('artists.edit', ['id' => $artist->id ]) }}"
                                                class="btn btn-warning mr-0 mb-3 mr-lg-2"
                                            >
                                                <i class="fa fa-edit"></i> Edit
                                            </a>
                                            <form method="POST" action="{{ route('artists.destroy', ['id' => $artist->id ]) }}">
                                                @csrf
                                                @method('delete')
                                        ...
                                        <td class="text-center">
                                            {{ $artist->created_at->format('F d, Y H:i:s') }}
                                        </td>
                                    </tr>
                                @empty
